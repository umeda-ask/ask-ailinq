...
const chatList = {
    ...
    9: { text: 'お問い合わせ内容を入力して送信ボタンを押してください。※当システムではAIによるフィルタリングを実施しており、ご入力内容によってはお答えが出来かねる場合がございます。以下に注意して相談をご入力ください。\r\n①問題が発生した日時や場所\r\n②関係者\r\n③これまでに行った対応\r\n④望む解決方法', continue: false, option: 'normal', return: false },
